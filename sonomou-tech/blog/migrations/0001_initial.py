    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorie', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fk_categorie', to='main.articlecategorie', verbose_name='Categorie')),
            ],
            options={
