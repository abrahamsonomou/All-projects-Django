...
class PersonneRessource(BaseModel):
...
class Info(BaseModel):
    ...
    apropos = QuillField(blank=True, null=True)
    address=models.CharField(max_length=200,null=True,blank=True)
    naissance=models.CharField(max_length=200,null=True,blank=True)
    ...
    competence=QuillField(blank=True, null=True)
    langue=QuillField(blank=True, null=True)
    formation=QuillField(blank=True, null=True)
    education=QuillField(blank=True, null=True)
    portfolio=models.TextField(blank=True,null=True,help_text="bref description")
    experience=QuillField(blank=True, null=True)
...
class Slider(models.Model):
    ...
    titre1=models.CharField(max_length=200,verbose_name="Titre",blank=True,null=True)
