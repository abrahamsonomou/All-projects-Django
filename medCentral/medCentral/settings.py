"""
Django settings for medCentral project.
...
SECRET_KEY = 'django-insecure-h%kn=iv39n*)ik*3&pu4(_d8!++qgidj=%dbf)&4o&cc@h_&gy'
...
WSGI_APPLICATION = 'medCentral.wsgi.application'
